...
object camion {
	...
	method cargar(unaCosa) {
		if (self.acepta(unaCosa)) carga.add(unaCosa) else error.throwWithMessage("No se puede cargar, supera el peso")
	}
...
object motoneta {
	...
	method cargar(unaCosa) {
		if (self.acepta(unaCosa)) carga.add(unaCosa) else error.throwWithMessage("No se puede cargar, supera el peso o el nivel de peligrosidad es muy alto")
	}
